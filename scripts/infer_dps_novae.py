...
def main():
    ...
    # ======================================================
    ref_path = os.path.join(cfg.ref_dir, f"arch0.mp4")
    ...
    def down_sample_by_frame(ds_input, scale_factor):
        ds_in_shape = [ds_input.shape[0], ds_input.shape[1], ds_input.shape[3], ds_input.shape[4]]  # down sample in img 1 C H W
